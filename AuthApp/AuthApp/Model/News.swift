...
class News  {
    ...
    func setUp () {
        ...
        let news1 = NewsIdentity(user: User(id: 0, image: "face1", name: "Вася", surname: "Крылов", photos: [UIImage(named: "face1")!], photoLikes: [2], isLiked: [false]),
        ...
        let news2 = NewsIdentity(user: User(id: 2, image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4], isLiked:[false,false]  ),
        ...
        let news3 = NewsIdentity(user: User(id: 2, image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4], isLiked: [false,false]  ),
        ...
        let news4 = NewsIdentity(user: User(id: 2, image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4], isLiked: [false,false]  ),
