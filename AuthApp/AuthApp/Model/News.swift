...
class News  {
    ...
    func setUp () {
        ...
        let news1 = NewsIdentity(user: User(image: "face1", name: "Вася", surname: "Крылов", photos: [UIImage(named: "face1")!], photoLikes: [2]),
        ...
        let news2 = NewsIdentity(user: User(image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4] ),
        ...
        let news3 = NewsIdentity(user: User(image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4] ),
        ...
        let news4 = NewsIdentity(user: User(image: "face3", name: "Елена",surname: "Смирнова", photos: [UIImage(named: "face3")!, UIImage(named: "face3pic1")!], photoLikes: [6,4] ),
